        ...
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-8">
                    ...
                    {type === "signup" ? <LabelledInput label="Name" placeholder="ABC DEF..." onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            name: e.target.value
                        })
...
function LabelledInput({ label, placeholder, onChange, type }: LabelledInputType) {
    return <div>
        ...
        text-sm rounded-lg focus:ring-blus-500 focus:border-blue-500 block w-full p-2.5 " placeholder={placeholder} required />
    </div>
}